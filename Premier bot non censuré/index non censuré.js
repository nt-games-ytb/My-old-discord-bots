...
client.on(`message`,message => {
    ...
    if(message.content === "Connard"){
        message.reply("Sa c'est moi qui te parle!https://www.youtube.com/watch?v=uI0TPQ5pirk");
        console.log('Le bot dit connard');
    }

    if(message.content === "Salope"){
        message.reply("Sa c'est moi qui te parle!https://www.youtube.com/watch?v=IAStOozNH7I");
    ...
    if(message.content === "**demande de commandes"){
        message.reply("ajoute mon créateur en amis nt games#0375 ou va sur le serveur où j'ai été creer https://discord.gg/CXtehtF et dit moi la commande que tu veux que je rajoute !");
